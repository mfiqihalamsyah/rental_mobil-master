      ...
      <div class="card">
        <div class="card-body">
          <form method="post" action="koneksi/proses.php?id=booking" enctype="multipart/form-data">
            ...
            <!-- <div class="form-group">
              <label for="">Nomor KTP</label>
              <input type="text" name="img_ktp" id="" required class="form-control">
            </div> -->
            <div class="form-group">
              <label for="" class="form-label">Foto KTP</label>
              <input type="file" accept="image/*" class="form-control col-sm-12" name="img_ktp" placeholder="Isi Gambar">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" name="lama_sewa" id="" required class="form-control" placeholder="Lama Sewa" min="1">
            </div>
