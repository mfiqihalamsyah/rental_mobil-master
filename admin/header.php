...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo $url; ?>admin/user/index.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo $url; ?>admin/mobil/mobil.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo $url; ?>admin/booking/booking.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo $url; ?>admin/peminjaman/peminjaman.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo $url; ?>admin/status/status.php">
